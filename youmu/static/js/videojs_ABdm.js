...
function ABPinit(){
	function Danmu(ele){
		...
		this.danmuShowControlContent.className = 'fi-comment-quotes';
		...
		if(typeof CommentManager !== "undefined"){
			...
			this.danmuShowControl.addEventListener("click", function(){
				if(_this.cmManager.display==true){
					...
					_this.cmManager.clear();
					_this.danmuShowControlContent.setAttribute("class","fi-comment-minus");
				}else{
					_this.cmManager.display=true;
					_this.danmuShowControlContent.setAttribute("class","fi-comment-quotes");
				}
			});
